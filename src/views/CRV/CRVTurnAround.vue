...
const formData = ref({
  ...
  phases: [
    // Phase Arrivée
    { nom: '[Arrivée] Calage avion', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Arrivée] Déchargement bagages', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Arrivée] Déchargement fret', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Arrivée] Livraison bagages', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },

    // Phase Transition
    { nom: '[Transition] Nettoyage cabine', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Transition] Avitaillement', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Transition] Contrôles techniques', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },

    // Phase Départ
    { nom: '[Départ] Enregistrement passagers', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Départ] Chargement bagages', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Départ] Chargement fret', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Départ] Embarquement passagers', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' },
    { nom: '[Départ] Repoussage', realisee: false, heureDebut: '', heureFin: '', observations: '', raisonNonRealisation: '' }
  ],
  charges: {
  ...
  if (currentStep.value < 7) {
    ...
    if (currentStep.value === 4) {
      if (!toutesPhaseTraitees.value) {
        ...
        alert(message)
        console.warn('[CRVTurnAround] Blocage étape 4 - Phases non traitées:', phasesNonTraitees.value)
        return
      }
    }
